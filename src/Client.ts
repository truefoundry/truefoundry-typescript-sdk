...
export class TrueFoundryClient {
    ...
    public get agentSkills(): AgentSkillsClient {
        return (this._agentSkills ??= new AgentSkillsClient(this._options));
    }

    public get agentSkillVersions(): AgentSkillVersionsClient {
     ...
     *     })
     */
    public apply(request: TrueFoundry.TrueFoundryApplyRequest, requestOptions?: TrueFoundryClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.TrueFoundryApplyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__apply(request, requestOptions));
    }

    private async __apply(request: TrueFoundry.TrueFoundryApplyRequest, requestOptions?: TrueFoundryClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.TrueFoundryApplyResponse>> {
     ...
     *     })
     */
    public delete(request: TrueFoundry.TrueFoundryDeleteRequest, requestOptions?: TrueFoundryClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.TrueFoundryDeleteResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(request, requestOptions));
    }

    private async __delete(request: TrueFoundry.TrueFoundryDeleteRequest, requestOptions?: TrueFoundryClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.TrueFoundryDeleteResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
