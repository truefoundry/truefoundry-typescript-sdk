...
export class TrueFoundryClient {
     ...
     *
     * @param {TrueFoundry.TfyApplyRequest} request
     ...
     */
    public apply(
        request: TrueFoundry.TfyApplyRequest,
        requestOptions?: TrueFoundryClient.RequestOptions,
    ): core.HttpResponsePromise<TrueFoundry.TfyApplyResponse> {
    ...
    private async __apply(
        request: TrueFoundry.TfyApplyRequest,
        requestOptions?: TrueFoundryClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueFoundry.TfyApplyResponse>> {
        ...
        if (_response.ok) {
            return { data: _response.body as TrueFoundry.TfyApplyResponse, rawResponse: _response.rawResponse };
        }
     ...
     *
     * @param {TrueFoundry.TfyDeleteRequest} request
     * @param {TrueFoundryClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.delete({
