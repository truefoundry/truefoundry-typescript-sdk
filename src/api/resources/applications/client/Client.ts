...
export class ApplicationsClient {
    ...
    public cancelDeployment(
        ...
        deploymentId: string,
        requestOptions?: ApplicationsClient.RequestOptions,
    ): core.HttpResponsePromise<TrueFoundry.CancelDeploymentApplicationsResponse> {
    ...
    private async __cancelDeployment(
        ...
        deploymentId: string,
        requestOptions?: ApplicationsClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueFoundry.CancelDeploymentApplicationsResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
