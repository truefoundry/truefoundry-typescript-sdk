...
export class ArtifactVersionsClient {
     ...
     *     })
     */
    public async list(request: TrueFoundry.ArtifactVersionsListRequest = {}, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.Page<TrueFoundry.ArtifactVersion, TrueFoundry.ListArtifactVersionsResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.ArtifactVersionsListRequest): Promise<core.WithRawResponse<TrueFoundry.ListArtifactVersionsResponse>> => { const { limit = 100, offset = 0, tag, fqn, artifactId, mlRepoId, name, version, runIds, runSteps, includeInternalMetadata = false } = request; const _queryParams: Record<string, unknown> = {
            limit,
            offset,
            tag,
            fqn,
     ...
     *     })
     */
    public applyTags(request: TrueFoundry.ApplyArtifactVersionTagsRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__applyTags(request, requestOptions));
    }

    private async __applyTags(request: TrueFoundry.ApplyArtifactVersionTagsRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
     ...
     *     })
     */
    public getSignedUrls(request: TrueFoundry.GetSignedUrLsRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetSignedUrLsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getSignedUrls(request, requestOptions));
    }

    private async __getSignedUrls(request: TrueFoundry.GetSignedUrLsRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetSignedUrLsResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     *     })
     */
    public createMultiPartUpload(request: TrueFoundry.CreateMultiPartUploadRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.MultiPartUploadResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createMultiPartUpload(request, requestOptions));
    }

    private async __createMultiPartUpload(request: TrueFoundry.CreateMultiPartUploadRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.MultiPartUploadResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     *     })
     */
    public async listFiles(request: TrueFoundry.ListFilesRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.Page<TrueFoundry.FileInfo, TrueFoundry.ListFilesResponse>> {
     ...
     *     })
     */
    public stage(request: TrueFoundry.StageArtifactRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.StageArtifactResponse> {
        return core.HttpResponsePromise.fromPromise(this.__stage(request, requestOptions));
    }

    private async __stage(request: TrueFoundry.StageArtifactRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.StageArtifactResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     *     })
     */
    public markStageFailure(request: TrueFoundry.MarkStageArtifactFailureRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__markStageFailure(request, requestOptions));
    }

    private async __markStageFailure(request: TrueFoundry.MarkStageArtifactFailureRequest, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     */
    public get(id: string, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetArtifactVersionResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetArtifactVersionResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     */
    public delete(id: string, requestOptions?: ArtifactVersionsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(id, requestOptions));
    }

    private async __delete(id: string, requestOptions?: ArtifactVersionsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/artifact-versions/${core.url.encodePathParam(id)}`),
