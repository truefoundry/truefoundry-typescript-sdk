...
export class ArtifactsClient {
     ...
     */
    public get(id: string, requestOptions?: ArtifactsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetArtifactResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: ArtifactsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetArtifactResponse>> {
     ...
     */
    public delete(id: string, requestOptions?: ArtifactsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(id, requestOptions));
    }

    private async __delete(id: string, requestOptions?: ArtifactsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/artifacts/${core.url.encodePathParam(id)}`),
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.ApplyArtifactRequest, requestOptions?: ArtifactsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetArtifactVersionResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.ApplyArtifactRequest, requestOptions?: ArtifactsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetArtifactVersionResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
