...
export class ClustersClient {
     ...
     *     })
     */
    public async list(request: TrueFoundry.ClustersListRequest = {}, requestOptions?: ClustersClient.RequestOptions): Promise<core.Page<TrueFoundry.Cluster, TrueFoundry.ListClustersResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.ClustersListRequest): Promise<core.WithRawResponse<TrueFoundry.ListClustersResponse>> => { const { limit = 100, offset = 0, attributes } = request; const _queryParams: Record<string, unknown> = {
            limit,
            offset,
            attributes
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.CreateOrUpdateClusterRequest, requestOptions?: ClustersClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetClusterResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.CreateOrUpdateClusterRequest, requestOptions?: ClustersClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetClusterResponse>> {
     ...
     */
    public get(id: string, requestOptions?: ClustersClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetClusterResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: ClustersClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetClusterResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
     ...
     */
    public delete(id: string, requestOptions?: ClustersClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.DeleteClusterResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(id, requestOptions));
    }

    private async __delete(id: string, requestOptions?: ClustersClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.DeleteClusterResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/clusters/${core.url.encodePathParam(id)}`),
     ...
     *     })
     */
    public getAddons(id: string, request: TrueFoundry.ClustersGetAddonsRequest = {}, requestOptions?: ClustersClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.ListClusterAddonsResponse> {
        return core.HttpResponsePromise.fromPromise(this.__getAddons(id, request, requestOptions));
    }

    private async __getAddons(id: string, request: TrueFoundry.ClustersGetAddonsRequest = {}, requestOptions?: ClustersClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.ListClusterAddonsResponse>> {
     ...
     */
    public isConnected(id: string, requestOptions?: ClustersClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.IsClusterConnectedResponse> {
        return core.HttpResponsePromise.fromPromise(this.__isConnected(id, requestOptions));
    }

    private async __isConnected(id: string, requestOptions?: ClustersClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.IsClusterConnectedResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
