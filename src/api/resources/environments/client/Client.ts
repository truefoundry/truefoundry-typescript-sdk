...
export class EnvironmentsClient {
    ...
    public async list(request: TrueFoundry.EnvironmentsListRequest = {}, requestOptions?: EnvironmentsClient.RequestOptions): Promise<core.Page<TrueFoundry.Environment, TrueFoundry.ListEnvironmentsResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.EnvironmentsListRequest): Promise<core.WithRawResponse<TrueFoundry.ListEnvironmentsResponse>> => { const { limit = 100, offset = 0 } = request; const _queryParams: Record<string, unknown> = {
            ...
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "api/svc/v1/environments"),
            method: "GET",
            headers: _headers,
            ...
            return { data: serializers.ListEnvironmentsResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        ...
        } return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/svc/v1/environments"); });
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.CreateOrUpdateEnvironmentRequest, requestOptions?: EnvironmentsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetEnvironmentResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.CreateOrUpdateEnvironmentRequest, requestOptions?: EnvironmentsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetEnvironmentResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.CreateOrUpdateEnvironmentRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
        ...
        if (_response.ok) {
            return { data: serializers.GetEnvironmentResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
     ...
     */
    public get(id: string, requestOptions?: EnvironmentsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetEnvironmentResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: EnvironmentsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetEnvironmentResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/environments/${core.url.encodePathParam(id)}`),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
    ...
    private async __delete(id: string, requestOptions?: EnvironmentsClient.RequestOptions): Promise<core.WithRawResponse<boolean>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/environments/${core.url.encodePathParam(id)}`),
        ...
        if (_response.ok) {
            return { data: serializers.environments.delete.Response.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/api/svc/v1/environments/{id}");
    }
}
