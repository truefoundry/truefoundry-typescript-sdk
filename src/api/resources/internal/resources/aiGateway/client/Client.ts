...
export class AiGatewayClient {
     ...
     */
    public getBudgetUsage(requestOptions?: AiGatewayClient.RequestOptions): core.HttpResponsePromise<void> {
        return core.HttpResponsePromise.fromPromise(this.__getBudgetUsage(requestOptions));
    }

    private async __getBudgetUsage(requestOptions?: AiGatewayClient.RequestOptions): Promise<core.WithRawResponse<void>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
