...
export class DeploymentsClient {
    ...
    private async __getDeploymentStatuses(
        ...
        if (_response.ok) {
            return {
                data: serializers.internal.deployments.getDeploymentStatuses.Response.parseOrThrow(_response.body, {
    ...
    private async __getBuilds(
        ...
        if (_response.ok) {
            return {
                data: serializers.internal.deployments.getBuilds.Response.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getCodeUploadUrl(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.internal.GenerateCodeUploadPresignedUrlRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
        ...
        if (_response.ok) {
            return {
                data: serializers.PresignedUrlObject.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getSuggestedEndpoint(
        ...
        const _queryParams: Record<string, unknown> = {
            applicationType: serializers.ApplicationType.jsonOrThrow(applicationType, {
                unrecognizedObjectKeys: "passthrough",
                allowUnrecognizedUnionMembers: true,
                allowUnrecognizedEnumValues: true,
                omitUndefined: true,
        ...
        if (_response.ok) {
            return {
                data: serializers.GetSuggestedDeploymentEndpointResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
