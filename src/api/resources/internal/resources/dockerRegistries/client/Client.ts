...
export class DockerRegistries {
    protected readonly _options: DockerRegistries.Options;

    constructor(_options: DockerRegistries.Options) {
    ...
    private async __createRepository(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.internal.CreateDockerRepositoryRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.internal.DockerRegistriesCreateRepositoryResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getCredentials(
        ...
        if (_response.ok) {
            return {
                data: serializers.internal.DockerRegistriesGetCredentialsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
