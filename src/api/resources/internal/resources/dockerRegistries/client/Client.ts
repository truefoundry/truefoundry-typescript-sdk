...
export class DockerRegistriesClient {
    ...
    private async __createRepository(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.internal.CreateDockerRepositoryRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.CreateDockerRepositoryResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __getCredentials(
        ...
        if (_response.ok) {
            return {
                data: serializers.GetDockerRegistryCredentialsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
