...
export class WorkflowsClient {
    ...
    ): core.HttpResponsePromise<TrueFoundry.internal.ExecuteWorkflowWorkflowsResponse> {
    ...
    private async __executeWorkflow(
        ...
        request: TrueFoundry.internal.ExecuteWorkflowRequest = {},
        requestOptions?: WorkflowsClient.RequestOptions,
    ): Promise<core.WithRawResponse<TrueFoundry.internal.ExecuteWorkflowWorkflowsResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.internal.ExecuteWorkflowRequest.jsonOrThrow(request, {
        ...
        if (_response.ok) {
            return {
                data: serializers.internal.ExecuteWorkflowWorkflowsResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
