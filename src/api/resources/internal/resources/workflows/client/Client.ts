...
export class WorkflowsClient {
    ...
    private async __executeWorkflow(applicationId: string, request: TrueFoundry.internal.ExecuteWorkflowRequest = {}, requestOptions?: WorkflowsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.internal.WorkflowsExecuteWorkflowResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/workflow/${core.url.encodePathParam(applicationId)}/executions`),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.internal.ExecuteWorkflowRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/api/svc/v1/workflow/{applicationId}/executions");
    }
}
