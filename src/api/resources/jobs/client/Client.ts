...
export class JobsClient {
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                const _queryParams: Record<string, unknown> = {
                    ...
                    sortBy:
                        sortBy != null
                            ? serializers.JobRunsSortBy.jsonOrThrow(sortBy, {
                    ...
                    order:
                        order != null
                            ? serializers.SortDirection.jsonOrThrow(order, {
                                  unrecognizedObjectKeys: "passthrough",
                                  allowUnrecognizedUnionMembers: true,
                                  allowUnrecognizedEnumValues: true,
                                  omitUndefined: true,
                    ...
                    status: Array.isArray(status)
                        ? status.map((item) =>
                              serializers.JobRunStatus.jsonOrThrow(item, {
                                  unrecognizedObjectKeys: "passthrough",
                                  allowUnrecognizedUnionMembers: true,
                                  allowUnrecognizedEnumValues: true,
                                  omitUndefined: true,
                        ...
                        : status != null
                          ? serializers.JobRunStatus.jsonOrThrow(status, {
                                unrecognizedObjectKeys: "passthrough",
                                allowUnrecognizedUnionMembers: true,
                                allowUnrecognizedEnumValues: true,
                                omitUndefined: true,
                ...
                if (_response.ok) {
                    return {
                        data: serializers.ListJobRunResponse.parseOrThrow(_response.body, {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
                            allowUnrecognizedEnumValues: true,
                            skipValidation: true,
    ...
    private async __getRun(
        ...
        if (_response.ok) {
            return {
                data: serializers.GetJobRunResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __deleteRun(
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteJobRunResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __trigger(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.TriggerJobRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
        ...
        if (_response.ok) {
            return {
                data: serializers.TriggerJobRunResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __terminate(
        ...
        if (_response.ok) {
            return {
                data: serializers.TerminateJobResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
