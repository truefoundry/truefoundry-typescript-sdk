...
export class MlReposClient {
     ...
     */
    public get(id: string, requestOptions?: MlReposClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetMlRepoResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: MlReposClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetMlRepoResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/ml-repos/${core.url.encodePathParam(id)}`),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return { data: serializers.GetMlRepoResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
     ...
     */
    public delete(id: string, requestOptions?: MlReposClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(id, requestOptions));
    }

    private async __delete(id: string, requestOptions?: MlReposClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/ml-repos/${core.url.encodePathParam(id)}`),
    ...
    public async list(request: TrueFoundry.MlReposListRequest = {}, requestOptions?: MlReposClient.RequestOptions): Promise<core.Page<TrueFoundry.MlRepo, TrueFoundry.ListMlReposResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.MlReposListRequest): Promise<core.WithRawResponse<TrueFoundry.ListMlReposResponse>> => { const { limit = 100, offset = 0, name, attributes } = request; const _queryParams: Record<string, unknown> = {
            ...
            return { data: serializers.ListMlReposResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        } if (_response.error.reason === "status-code") {
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.ApplyMlRepoRequest, requestOptions?: MlReposClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetMlRepoResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.ApplyMlRepoRequest, requestOptions?: MlReposClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetMlRepoResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "api/svc/v1/ml-repos"),
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.ApplyMlRepoRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
