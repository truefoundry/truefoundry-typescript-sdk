...
export class Models {
     ...
     */
    public async get(id: string, requestOptions?: Models.RequestOptions): Promise<TrueFoundry.GetModelResponse> {
        ...
        if (_response.ok) {
            return _response.body as TrueFoundry.GetModelResponse;
        }
     ...
     */
    public async delete(id: string, requestOptions?: Models.RequestOptions): Promise<TrueFoundry.EmptyResponse> {
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: urlJoin(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    (await core.Supplier.get(this._options.environment)),
    ...
    public async list(
        ...
        const list = async (request: TrueFoundry.ModelsListRequest): Promise<TrueFoundry.ListModelsResponse> => {
            ...
            if (_response.ok) {
                return _response.body as TrueFoundry.ListModelsResponse;
            }
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 422:
