...
export class PromptsClient {
     ...
     */
    public get(id: string, requestOptions?: PromptsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetPromptResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: PromptsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetPromptResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/prompts/${core.url.encodePathParam(id)}`),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return { data: serializers.GetPromptResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
     ...
     */
    public delete(id: string, requestOptions?: PromptsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.EmptyResponse> {
        return core.HttpResponsePromise.fromPromise(this.__delete(id, requestOptions));
    }

    private async __delete(id: string, requestOptions?: PromptsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.EmptyResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/prompts/${core.url.encodePathParam(id)}`),
    ...
    public async list(request: TrueFoundry.PromptsListRequest = {}, requestOptions?: PromptsClient.RequestOptions): Promise<core.Page<TrueFoundry.Prompt, TrueFoundry.ListPromptsResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.PromptsListRequest): Promise<core.WithRawResponse<TrueFoundry.ListPromptsResponse>> => { const { limit = 100, offset = 0, fqn, mlRepoId, name, includeEmptyPrompts = true } = request; const _queryParams: Record<string, unknown> = {
            ...
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "api/svc/v1/prompts"),
            method: "GET",
            headers: _headers,
            ...
            return { data: serializers.ListPromptsResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        } if (_response.error.reason === "status-code") {
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.ApplyPromptRequest, requestOptions?: PromptsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetPromptVersionResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.ApplyPromptRequest, requestOptions?: PromptsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetPromptVersionResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.ApplyPromptRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
