...
export class SecretGroupsClient {
    ...
    public async list(
        ...
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                ...
                if (_response.ok) {
                    return {
                        data: serializers.ListSecretGroupResponse.parseOrThrow(_response.body, {
    ...
    private async __create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            body: mergeAdditionalBodyParameters(
                serializers.CreateSecretGroupRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
        ...
        if (_response.ok) {
            return {
                data: serializers.GetSecretGroupResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
    ...
    private async __createOrUpdate(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.CreateOrUpdateSecretGroupRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
    ...
    private async __update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: mergeAdditionalBodyParameters(
                serializers.UpdateSecretGroupRequest.jsonOrThrow(request, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    omitUndefined: true,
    ...
    private async __delete(
        ...
        if (_response.ok) {
            return {
                data: serializers.DeleteSecretGroupResponse.parseOrThrow(_response.body, {
                    unrecognizedObjectKeys: "passthrough",
                    allowUnrecognizedUnionMembers: true,
                    allowUnrecognizedEnumValues: true,
                    skipValidation: true,
