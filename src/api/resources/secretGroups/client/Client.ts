...
export class SecretGroupsClient {
    ...
    public async list(request: TrueFoundry.SecretGroupsListRequest = {}, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.Page<TrueFoundry.SecretGroup, TrueFoundry.ListSecretGroupResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(async (request: TrueFoundry.SecretGroupsListRequest): Promise<core.WithRawResponse<TrueFoundry.ListSecretGroupResponse>> => { const { limit = 100, offset = 0, fqn, search, attributes } = request; const _queryParams: Record<string, unknown> = {
            ...
            return { data: serializers.ListSecretGroupResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        ...
        } return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/svc/v1/secret-groups"); });
     ...
     *     })
     */
    public create(request: TrueFoundry.CreateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetSecretGroupResponse> {
        return core.HttpResponsePromise.fromPromise(this.__create(request, requestOptions));
    }

    private async __create(request: TrueFoundry.CreateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetSecretGroupResponse>> {
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            requestType: "json",
            body: serializers.CreateSecretGroupRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
        ...
        if (_response.ok) {
            return { data: serializers.GetSecretGroupResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
        ...
        if (_response.error.reason === "status-code") {
            switch (_response.error.statusCode) {
                ...
                case 424: throw new TrueFoundry.FailedDependencyError(serializers.HttpError.parseOrThrow(_response.error.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), _response.rawResponse);
     ...
     *     })
     */
    public createOrUpdate(request: TrueFoundry.CreateOrUpdateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetSecretGroupResponse> {
        return core.HttpResponsePromise.fromPromise(this.__createOrUpdate(request, requestOptions));
    }

    private async __createOrUpdate(request: TrueFoundry.CreateOrUpdateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetSecretGroupResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), "api/svc/v1/secret-groups"),
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.CreateOrUpdateSecretGroupRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
     ...
     */
    public get(id: string, requestOptions?: SecretGroupsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetSecretGroupResponse> {
        return core.HttpResponsePromise.fromPromise(this.__get(id, requestOptions));
    }

    private async __get(id: string, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetSecretGroupResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/secret-groups/${core.url.encodePathParam(id)}`),
            method: "GET",
            headers: _headers,
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/api/svc/v1/secret-groups/{id}");
    }
     ...
     *     })
     */
    public update(id: string, request: TrueFoundry.UpdateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): core.HttpResponsePromise<TrueFoundry.GetSecretGroupResponse> {
        return core.HttpResponsePromise.fromPromise(this.__update(id, request, requestOptions));
    }

    private async __update(id: string, request: TrueFoundry.UpdateSecretGroupRequest, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.GetSecretGroupResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        let _headers: core.Fetcher.Args["headers"] = mergeHeaders(_authRequest.headers, this._options?.headers, requestOptions?.headers);
        const _response = await (this._options.fetcher ?? core.fetcher)({
            url: core.url.join(await core.Supplier.get(this._options.baseUrl) ?? await core.Supplier.get(this._options.environment), `api/svc/v1/secret-groups/${core.url.encodePathParam(id)}`),
            ...
            queryString: core.url.queryBuilder().mergeAdditional(requestOptions?.queryParams).build(),
            requestType: "json",
            body: serializers.UpdateSecretGroupRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, omitUndefined: true }),
            timeoutMs: (requestOptions?.timeoutInSeconds ?? this._options?.timeoutInSeconds ?? 60) * 1000,
            maxRetries: requestOptions?.maxRetries ?? this._options?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
            fetchFn: this._options?.fetch,
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/api/svc/v1/secret-groups/{id}");
    }
    ...
    private async __delete(id: string, request: TrueFoundry.SecretGroupsDeleteRequest = {}, requestOptions?: SecretGroupsClient.RequestOptions): Promise<core.WithRawResponse<TrueFoundry.DeleteSecretGroupResponse>> {
        ...
        if (_response.ok) {
            return { data: serializers.DeleteSecretGroupResponse.parseOrThrow(_response.body, { unrecognizedObjectKeys: "passthrough", allowUnrecognizedUnionMembers: true, allowUnrecognizedEnumValues: true, skipValidation: true, breadcrumbsPrefix: ["response"] }), rawResponse: _response.rawResponse };
        }
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/api/svc/v1/secret-groups/{id}");
    }
}
