...
export const UpdateUserRolesRequestResourceType = {
    Role: "role",
    Account: "account",
    Cluster: "cluster",
    Workspace: "workspace",
    ...
    GatewayApprovalRequest: "gateway-approval-request",
...
export type UpdateUserRolesRequestResourceType =
    (typeof UpdateUserRolesRequestResourceType)[keyof typeof UpdateUserRolesRequestResourceType];
