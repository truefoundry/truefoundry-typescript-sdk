...
export const ApplyPromptVersionTagsRequest: core.serialization.Schema<
    serializers.ApplyPromptVersionTagsRequest.Raw,
    TrueFoundry.ApplyPromptVersionTagsRequest
