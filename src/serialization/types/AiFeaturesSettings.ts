...
export const AiFeaturesSettings: core.serialization.ObjectSchema<serializers.AiFeaturesSettings.Raw, TrueFoundry.AiFeaturesSettings> = core.serialization.object({
