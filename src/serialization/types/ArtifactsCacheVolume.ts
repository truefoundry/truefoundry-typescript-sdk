...
export const ArtifactsCacheVolume: core.serialization.ObjectSchema<serializers.ArtifactsCacheVolume.Raw, TrueFoundry.ArtifactsCacheVolume> = core.serialization.object({
