...
export const AsyncProcessorSidecar: core.serialization.ObjectSchema<serializers.AsyncProcessorSidecar.Raw, TrueFoundry.AsyncProcessorSidecar> = core.serialization.object({
