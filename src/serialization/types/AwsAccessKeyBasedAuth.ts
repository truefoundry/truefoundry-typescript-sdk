...
export const AwsAccessKeyBasedAuth: core.serialization.ObjectSchema<serializers.AwsAccessKeyBasedAuth.Raw, TrueFoundry.AwsAccessKeyBasedAuth> = core.serialization.object({
