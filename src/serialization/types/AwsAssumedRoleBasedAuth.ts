...
export const AwsAssumedRoleBasedAuth: core.serialization.ObjectSchema<serializers.AwsAssumedRoleBasedAuth.Raw, TrueFoundry.AwsAssumedRoleBasedAuth> = core.serialization.object({
