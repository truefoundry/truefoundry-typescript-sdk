...
export const AwsBedrockGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.AwsBedrockGuardrailConfigConfig.Raw,
    TrueFoundry.AwsBedrockGuardrailConfigConfig
