...
export const AzureContentSafetyGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.AzureContentSafetyGuardrailConfigConfig.Raw,
    TrueFoundry.AzureContentSafetyGuardrailConfigConfig
