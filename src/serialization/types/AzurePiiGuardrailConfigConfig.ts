...
export const AzurePiiGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.AzurePiiGuardrailConfigConfig.Raw,
    TrueFoundry.AzurePiiGuardrailConfigConfig
