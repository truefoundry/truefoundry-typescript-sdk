...
export const AzurePromptShieldGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.AzurePromptShieldGuardrailConfigConfig.Raw,
    TrueFoundry.AzurePromptShieldGuardrailConfigConfig
