...
export const BaseWorkbenchInput: core.serialization.ObjectSchema<serializers.BaseWorkbenchInput.Raw, TrueFoundry.BaseWorkbenchInput> = core.serialization.object({
