...
export const BasetenModel: core.serialization.ObjectSchema<serializers.BasetenModel.Raw, TrueFoundry.BasetenModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/baseten"),
...
export declare namespace BasetenModel {
