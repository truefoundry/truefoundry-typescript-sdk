...
export const BlobStorageReference: core.serialization.ObjectSchema<serializers.BlobStorageReference.Raw, TrueFoundry.BlobStorageReference> = core.serialization.object({
