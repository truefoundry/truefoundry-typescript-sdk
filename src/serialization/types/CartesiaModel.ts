...
export const CartesiaModel: core.serialization.ObjectSchema<serializers.CartesiaModel.Raw, TrueFoundry.CartesiaModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/cartesia"),
