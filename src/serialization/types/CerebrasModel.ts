...
export const CerebrasModel: core.serialization.ObjectSchema<serializers.CerebrasModel.Raw, TrueFoundry.CerebrasModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/cerebras"),
...
export declare namespace CerebrasModel {
