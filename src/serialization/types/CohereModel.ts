...
export const CohereModel: core.serialization.ObjectSchema<serializers.CohereModel.Raw, TrueFoundry.CohereModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/cohere"),
...
export declare namespace CohereModel {
