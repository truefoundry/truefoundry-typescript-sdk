...
export const CustomBlobStorage: core.serialization.ObjectSchema<serializers.CustomBlobStorage.Raw, TrueFoundry.CustomBlobStorage> = core.serialization.object({
