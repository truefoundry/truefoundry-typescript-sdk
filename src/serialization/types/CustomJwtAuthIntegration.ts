...
export const CustomJwtAuthIntegration: core.serialization.ObjectSchema<serializers.CustomJwtAuthIntegration.Raw, TrueFoundry.CustomJwtAuthIntegration> = core.serialization.object({
