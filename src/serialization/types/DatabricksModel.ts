...
export const DatabricksModel: core.serialization.ObjectSchema<serializers.DatabricksModel.Raw, TrueFoundry.DatabricksModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/databricks"),
...
export declare namespace DatabricksModel {
