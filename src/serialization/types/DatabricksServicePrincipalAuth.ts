...
export const DatabricksServicePrincipalAuth: core.serialization.ObjectSchema<serializers.DatabricksServicePrincipalAuth.Raw, TrueFoundry.DatabricksServicePrincipalAuth> = core.serialization.object({
