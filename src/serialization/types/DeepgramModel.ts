...
export const DeepgramModel: core.serialization.ObjectSchema<serializers.DeepgramModel.Raw, TrueFoundry.DeepgramModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/deepgram"),
...
export declare namespace DeepgramModel {
