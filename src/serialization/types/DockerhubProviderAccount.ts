...
export const DockerhubProviderAccount: core.serialization.ObjectSchema<serializers.DockerhubProviderAccount.Raw, TrueFoundry.DockerhubProviderAccount> = core.serialization.object({
