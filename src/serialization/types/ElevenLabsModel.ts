...
export const ElevenLabsModel: core.serialization.ObjectSchema<serializers.ElevenLabsModel.Raw, TrueFoundry.ElevenLabsModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/elevenlabs"),
...
export declare namespace ElevenLabsModel {
