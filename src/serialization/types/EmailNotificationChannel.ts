...
export const EmailNotificationChannel: core.serialization.ObjectSchema<serializers.EmailNotificationChannel.Raw, TrueFoundry.EmailNotificationChannel> = core.serialization.object({
