...
export const EnvironmentManifest: core.serialization.ObjectSchema<serializers.EnvironmentManifest.Raw, TrueFoundry.EnvironmentManifest> = core.serialization.object({
