...
export const GcpGkeIntegration: core.serialization.ObjectSchema<serializers.GcpGkeIntegration.Raw, TrueFoundry.GcpGkeIntegration> = core.serialization.object({
