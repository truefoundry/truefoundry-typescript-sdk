...
export const GetDockerRegistryCredentialsResponse: core.serialization.ObjectSchema<
    serializers.GetDockerRegistryCredentialsResponse.Raw,
    TrueFoundry.GetDockerRegistryCredentialsResponse
