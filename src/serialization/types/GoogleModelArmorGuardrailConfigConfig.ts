...
export const GoogleModelArmorGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.GoogleModelArmorGuardrailConfigConfig.Raw,
    TrueFoundry.GoogleModelArmorGuardrailConfigConfig
