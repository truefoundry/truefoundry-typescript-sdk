...
export const HealthProbe: core.serialization.ObjectSchema<serializers.HealthProbe.Raw, TrueFoundry.HealthProbe> = core.serialization.object({
        "config": HttpProbe,
        "initialDelaySeconds": core.serialization.property("initial_delay_seconds", core.serialization.number().optional()),
