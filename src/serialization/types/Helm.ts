...
import { HelmSource } from "./HelmSource.js";
...
export const Helm: core.serialization.ObjectSchema<serializers.Helm.Raw, TrueFoundry.Helm> = core.serialization.object({
        ...
        "ignoreDifferences": core.serialization.list(core.serialization.record(core.serialization.string(), core.serialization.unknown())).optional(),
