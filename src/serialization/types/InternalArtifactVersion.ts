...
export const InternalArtifactVersion: core.serialization.ObjectSchema<serializers.InternalArtifactVersion.Raw, TrueFoundry.InternalArtifactVersion> = core.serialization.object({
        ...
        "artifactMetadata": core.serialization.property("artifact_metadata", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optionalNullable()),
        "internalMetadata": core.serialization.property("internal_metadata", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optionalNullable())
    });
