...
export const JfrogProviderAccount: core.serialization.ObjectSchema<serializers.JfrogProviderAccount.Raw, TrueFoundry.JfrogProviderAccount> = core.serialization.object({
