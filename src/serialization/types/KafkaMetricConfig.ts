...
export const KafkaMetricConfig: core.serialization.ObjectSchema<serializers.KafkaMetricConfig.Raw, TrueFoundry.KafkaMetricConfig> = core.serialization.object({
