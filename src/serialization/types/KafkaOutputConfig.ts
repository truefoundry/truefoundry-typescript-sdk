...
export const KafkaOutputConfig: core.serialization.ObjectSchema<serializers.KafkaOutputConfig.Raw, TrueFoundry.KafkaOutputConfig> = core.serialization.object({
