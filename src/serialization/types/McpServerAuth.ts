...
export const McpServerAuth: core.serialization.Schema<serializers.McpServerAuth.Raw, TrueFoundry.McpServerAuth> = core.serialization.undiscriminatedUnion([McpServerHeaderAuth, McpServerOAuth2, McpServerPassthrough]);
