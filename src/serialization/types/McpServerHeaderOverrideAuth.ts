...
export const McpServerHeaderOverrideAuth: core.serialization.ObjectSchema<
    serializers.McpServerHeaderOverrideAuth.Raw,
    TrueFoundry.McpServerHeaderOverrideAuth
