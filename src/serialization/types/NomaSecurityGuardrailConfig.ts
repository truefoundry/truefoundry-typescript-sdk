...
export const NomaSecurityGuardrailConfig: core.serialization.ObjectSchema<serializers.NomaSecurityGuardrailConfig.Raw, TrueFoundry.NomaSecurityGuardrailConfig> = core.serialization.object({
