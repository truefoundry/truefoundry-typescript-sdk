...
export const NomaSecurityGuardrailConfigConfig: core.serialization.ObjectSchema<serializers.NomaSecurityGuardrailConfigConfig.Raw, TrueFoundry.NomaSecurityGuardrailConfigConfig> = core.serialization.object({
