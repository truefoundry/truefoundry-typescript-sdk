...
export const NomicModel: core.serialization.ObjectSchema<serializers.NomicModel.Raw, TrueFoundry.NomicModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/nomic"),
...
export declare namespace NomicModel {
