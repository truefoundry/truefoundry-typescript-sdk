...
export const NvidiaTimeslicingGpu: core.serialization.ObjectSchema<serializers.NvidiaTimeslicingGpu.Raw, TrueFoundry.NvidiaTimeslicingGpu> = core.serialization.object({
