...
export const OllamaModel: core.serialization.ObjectSchema<serializers.OllamaModel.Raw, TrueFoundry.OllamaModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/ollama"),
