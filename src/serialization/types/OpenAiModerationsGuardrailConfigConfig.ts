...
export const OpenAiModerationsGuardrailConfigConfig: core.serialization.ObjectSchema<
    serializers.OpenAiModerationsGuardrailConfigConfig.Raw,
    TrueFoundry.OpenAiModerationsGuardrailConfigConfig
