...
export const PalmModel: core.serialization.ObjectSchema<serializers.PalmModel.Raw, TrueFoundry.PalmModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/palm"),
...
export declare namespace PalmModel {
