...
export const PerplexityAiModel: core.serialization.ObjectSchema<serializers.PerplexityAiModel.Raw, TrueFoundry.PerplexityAiModel> = core.serialization.object({
