...
export const PrometheusAlertRule: core.serialization.ObjectSchema<serializers.PrometheusAlertRule.Raw, TrueFoundry.PrometheusAlertRule> = core.serialization.object({
