...
export const QuayProviderAccount: core.serialization.ObjectSchema<serializers.QuayProviderAccount.Raw, TrueFoundry.QuayProviderAccount> = core.serialization.object({
