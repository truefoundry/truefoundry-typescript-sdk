...
export const SagemakerModel: core.serialization.ObjectSchema<serializers.SagemakerModel.Raw, TrueFoundry.SagemakerModel> = core.serialization.object({
        "name": core.serialization.string(),
        "modelId": core.serialization.property("model_id", core.serialization.string()),
        "type": core.serialization.stringLiteral("integration/model/sagemaker"),
...
export declare namespace SagemakerModel {
