...
export const SparkJobScalaNotebookEntrypoint: core.serialization.ObjectSchema<serializers.SparkJobScalaNotebookEntrypoint.Raw, TrueFoundry.SparkJobScalaNotebookEntrypoint> = core.serialization.object({
