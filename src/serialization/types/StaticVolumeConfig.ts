...
export const StaticVolumeConfig: core.serialization.ObjectSchema<serializers.StaticVolumeConfig.Raw, TrueFoundry.StaticVolumeConfig> = core.serialization.object({
