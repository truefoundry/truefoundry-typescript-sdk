...
export const TrueFoundryAgentModelParams: core.serialization.ObjectSchema<
    serializers.TrueFoundryAgentModelParams.Raw,
    TrueFoundry.TrueFoundryAgentModelParams
