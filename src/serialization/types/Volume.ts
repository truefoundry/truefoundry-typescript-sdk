...
import { VolumeConfig } from "./VolumeConfig.js";

export const Volume: core.serialization.ObjectSchema<serializers.Volume.Raw, TrueFoundry.Volume> = core.serialization.object({
