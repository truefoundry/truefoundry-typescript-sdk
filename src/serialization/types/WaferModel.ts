...
export const WaferModel: core.serialization.ObjectSchema<serializers.WaferModel.Raw, TrueFoundry.WaferModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/wafer"),
...
export declare namespace WaferModel {
