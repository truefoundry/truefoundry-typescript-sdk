...
export const WorkspaceManifest: core.serialization.ObjectSchema<serializers.WorkspaceManifest.Raw, TrueFoundry.WorkspaceManifest> = core.serialization.object({
