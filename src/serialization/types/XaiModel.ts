...
export const XaiModel: core.serialization.ObjectSchema<serializers.XaiModel.Raw, TrueFoundry.XaiModel> = core.serialization.object({
        "type": core.serialization.stringLiteral("integration/model/xai"),
