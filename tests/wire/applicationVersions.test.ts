...
describe("ApplicationVersionsClient", () => {
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/apps/id/deployments/deploymentId").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
