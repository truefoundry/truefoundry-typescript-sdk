...
describe("PromptVersionsClient", () => {
    ...
    test("list", async () => {
        ...
        const rawResponseBody = { "data" : [ { "created_at" : "2024-01-15T09:30:00Z" , "updated_at" : "2024-01-15T09:30:00Z" , "manifest" : { "metadata" : { "key" : "value" } , "type" : "chat_prompt" , "messages" : [ { "role" : "system" , "content" : "content" } ] } , "id" : "id" , "fqn" : "fqn" , "created_by_subject" : { "subjectId" : "subjectId" , "subjectType" : "user" } , "ml_repo_id" : "ml_repo_id" , "usage_code_snippet" : "usage_code_snippet" , "usage_code_snippets" : [ { "display_name" : "display_name" , "language" : "language" , "code" : "code" } ] , "tags" : [ "tags" ] , "prompt_id" : "prompt_id" } ] , "pagination" : { "total" : 100 , "offset" : 0 , "limit" : 10 } };
        
        server
            .mockEndpoint({ once: false })
            .get("/api/svc/v1/prompt-versions").respondWith()
    ...
    test("apply_tags", async () => {
        ...
        server
            .mockEndpoint()
            .put("/api/svc/v1/prompt-versions/tags").jsonBody(rawRequestBody)
                .respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/prompt-versions/id").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
    ...
    test("delete (1)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/api/svc/v1/prompt-versions/id").respondWith()
            .statusCode(200).jsonBody(rawResponseBody)
                .build();
