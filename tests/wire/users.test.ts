...
describe("UsersClient", () => {
    ...
    test("get_resources (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/jqfwg345gi25n5ju2yz5iz6m/resources")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get_resources (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/id/resources")
            .respondWith()
            .statusCode(403)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get_permissions (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/jqfwg345gi25n5ju2yz5iz6m/permissions")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get_permissions (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/id/permissions")
            .respondWith()
            .statusCode(403)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get_teams (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/jqfwg345gi25n5ju2yz5iz6m/teams")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get_teams (2)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/api/svc/v1/x/users/id/teams")
            .respondWith()
            .statusCode(403)
            .jsonBody(rawResponseBody)
            .build();
